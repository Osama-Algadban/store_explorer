...
@lazySingleton
class ProductsSearchUseCases {
  ProductsRepository get repository => ProductsRepositoryImpl();

  Future<Either<Failure, ProductsPaginationEntity>> getProductsWithSearch(ProductsParams params) => repository.getProductsWithSearch(params);
}